    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[60vh] w-full">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          <h1 className="text-5xl md:text-7xl font-heading font-bold mb-6">{wrmLiteCopy.heroTitle}</h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <section className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
            <h2 className="text-3xl font-heading font-bold mb-8">{wrmLiteCopy.bulletsTitle}</h2>
            ...
            <p className="mt-8 text-white/80">{wrmLiteCopy.delivery}</p>
            <p className="mt-6 text-white/80">{wrmLiteCopy.beliefShift}</p>
            <div className="mt-8 p-6 bg-red-900/20 border border-red-500/30 rounded-xl">
              <p className="font-heading font-bold text-xl">{wrmLiteCopy.priceLine}</p>
              <p className="text-white/70 mt-2">{wrmLiteCopy.scarcity}</p>
            </div>
          </div>

          <aside className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
            <h3 className="text-2xl font-heading font-bold mb-6">Start Your Intake</h3>
            <div className="space-y-4">
              ...
              <div className="pt-2">
                <p className="text-lg font-heading font-semibold mb-3">Top platforms</p>
                  ...
                  {["Instagram", "Facebook", "TikTok", "LinkedIn"].map(p => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl border transition-all duration-200 font-body ${
                          active 
