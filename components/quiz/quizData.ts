...
const q1: QuizQuestion = {
  ...
  options: [
    ...
    { label: "I've grown, but my brand doesn't reflect my success.", result: "wrm_lite", ppbSignal: true },
...
const q2: QuizQuestion = {
  ...
  options: [
    ...
    { label: "Looking like the authority I already am, with a brand that reflects my success.", result: "wrm_lite", ppbSignal: true },
...
const q3: QuizQuestion = {
  ...
  options: [
    ...
    { label: "I have some content, but it doesn't match the level I'm operating at.", result: "wrm_lite", ppbSignal: true },
...
const q4: QuizQuestion = {
  ...
  options: [
    ...
    { label: "Becoming the go-to authority in my industry.", result: "wrm_lite", ppbSignal: true },
...
const q5: QuizQuestion = {
  ...
  options: [
    ...
    { label: "A solid mix of photo and video content that matches my level.", result: "wrm_lite", ppbSignal: true },
...
const q6: QuizQuestion = {
  ...
  options: [
    ...
    { label: "I have a little help, but I'm still the one driving it all.", result: "wrm_lite", ppbSignal: true },
...
const q7: QuizQuestion = {
  ...
  options: [
    { label: "I want to learn the full framework and build my brand with live coaching over 8 weeks.", result: "wrm_lite", ppbSignal: true },
